...
// Fetch garden products from the database
$sql = "SELECT * FROM products WHERE products.category_id = 2";
...
<head>
    ...
    <!-- site metas -->
    <title>Garden</title>
    <meta name="keywords" content="Garden Products">
...
<body class="main-layout product_page">
    ...
    <!-- plant -->
    <div id="garden" class="section product">
        <div class="container">
            <div class="row">
                <div class="col-md-12 ">
                    <div class="titlepage">
                        <h2><strong class="black"> Garden</strong> Products</h2>
                        <span>Curate a harmonious outdoor haven with our thoughtfully selected garden essentials. From durable watering cans to charming garden gnomes, 
                              explore products that seamlessly blend into your garden, embracing both nature and sustainability.</span>
                    </div>
                </div>
            </div>
        </div>
